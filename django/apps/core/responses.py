...
class APIResponse:
    ...
    @staticmethod
    def created(
        data: Any = None, message: str = "Created successfully", **kwargs
    ) -> Response:
        """Created response (201)."""
        return APIResponse.success(
            data=data, message=message, status_code=status.HTTP_201_CREATED, **kwargs
        )
...
def error_response(
    message="Error", status_code=400, code="error", errors=None, **kwargs
):
