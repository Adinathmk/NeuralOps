...
_dynamo_region   = os.getenv('DYNAMODB_REGION') or os.getenv('AWS_REGION_NAME', 'us-east-1')
_dynamo_key      = os.getenv('DYNAMODB_ACCESS_KEY_ID') or os.getenv('AWS_ACCESS_KEY_ID')
_dynamo_secret   = os.getenv('DYNAMODB_SECRET_ACCESS_KEY') or os.getenv('AWS_SECRET_ACCESS_KEY')
