    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner - Full access, can manage billing'), ('admin', 'Admin - Full access, cannot manage billing'), ('engineer', 'Engineer - Can view/interact with incidents'), ('viewer', 'Viewer - Read-only access')], default='engineer', max_length=20)),
                ...
                ('tenant', models.ForeignKey(blank=True, help_text='Null for platform admins, set for tenant users', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='tenants.tenant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('USER_CREATED', 'User Created'), ('USER_UPDATED', 'User Updated'), ('USER_DELETED', 'User Deleted'), ('LOGIN', 'Login'), ('LOGOUT', 'Logout'), ('API_KEY_CREATED', 'API Key Created')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted_by', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invitation_accepted', to=settings.AUTH_USER_MODEL)),
