...
class TestGoogleOAuthCallback:
    ...
    def test_owner_signup_new_google_account(
        self, mock_get_info, mock_exchange, api_client
    ):
    ...
    @patch("users.services.oauth_providers.GoogleOAuthService.exchange_code_for_token")
    @patch("users.services.oauth_providers.GoogleOAuthService.get_user_info")
    def test_owner_signin_existing_oauth(
        self, mock_get_info, mock_exchange, api_client, google_oauth_account
    ):
    ...
    @patch("users.services.oauth_providers.GoogleOAuthService.exchange_code_for_token")
    @patch("users.services.oauth_providers.GoogleOAuthService.get_user_info")
    def test_engineer_join_via_google_invitation(
        self, mock_get_info, mock_exchange, api_client, invitation
    ):
...
class TestGitHubOAuthCallback:
    ...
    def test_owner_signup_new_github_account(
        self, mock_get_info, mock_exchange, api_client
    ):
    ...
    @patch("users.services.oauth_providers.GitHubOAuthService.get_user_info")
    def test_owner_signin_existing_oauth(
        self, mock_get_info, mock_exchange, api_client, owner_user
    ):
        """Test owner signin with existing OAuth account."""
    ...
    @patch("users.services.oauth_providers.GitHubOAuthService.exchange_code_for_token")
    @patch("users.services.oauth_providers.GitHubOAuthService.get_user_info")
    def test_engineer_join_via_github_invitation(
        self, mock_get_info, mock_exchange, api_client, invitation
    ):
