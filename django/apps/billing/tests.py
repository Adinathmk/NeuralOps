...
class RazorpayWebhookTests(TestCase):
    ...
    def generate_signature(self, payload):
        secret = "test_secret"
        return hmac.new(secret.encode('utf-8'), json.dumps(payload).encode('utf-8'), hashlib.sha256).hexdigest()
    ...
    def test_valid_signature_charged(self):
        ...
        self.assertTrue(BillingEvent.objects.filter(razorpay_event_id="evt_123").exists())
