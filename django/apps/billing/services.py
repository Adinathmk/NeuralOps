...
def get_or_create_customer(tenant):
    ...
    customer_data = {"name": tenant.name, "notes": {"tenant_id": str(tenant.id)}}
...
def create_subscription(tenant, plan_id, plan_tier):
    ...
    subscription_data = {
        ...
        "notes": {"tenant_id": str(tenant.id), "plan_tier": plan_tier},
    }
...
def update_subscription(subscription_id, plan_id, schedule_change_at="cycle_end"):
    ...
    """
    update_data = {"plan_id": plan_id, "schedule_change_at": schedule_change_at}
