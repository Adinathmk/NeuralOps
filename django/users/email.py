...
class EmailService:
    ...
    def send_invitation_email(invitation, frontend_url):
        ...
        context = {
            ...
            'invited_by_name': invitation.invited_by.get_full_name() if invitation.invited_by else 'Admin',
            'join_link': join_link,
    ...
    def send_team_member_joined_notification(invitation):
        ...
        context = {
            'admin_name': invitation.invited_by.get_full_name() if invitation.invited_by else 'Admin',
            'engineer_email': invitation.email,
        ...
        try:
            send_mail(
                ...
                message=plain_message,
                from_email=settings.DEFAULT_FROM_EMAIL,
                recipient_list=[invitation.invited_by.email] if invitation.invited_by else [],
                html_message=html_message,
                fail_silently=False,
            )
